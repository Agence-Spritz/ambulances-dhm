...
// VARIABLES
$titrepage= "<i class='fa fa-star'></i> Blog / Actu";
$tableencours = $table_prefix."_pages";
$page = "blog"; 										// Variable pour definir la sous cat page
...
<div id="contenu" style="width:<?=$largtabl*0.6?>px; float:left" class="normalgris">
        ...
        <p><span class="libchamps"><i class='fa fa-pencil-square-o fa-1x'></i> Sous-titre :</span><input name="<?=$chps[6]?>" value="<?=$$chps[6]?>" type="text" required size="75" /></p>
    ...
    <div id="contenu" style="width:<?=$largtabl*0.6?>px; float:left; margin-top:10px" class="normalgris" align="center">
      <p class="grandnoir"><i class='fa fa-align-justify fa-1x'></i> Descriptif</p> 
